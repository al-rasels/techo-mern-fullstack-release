...
function ProductList() {
  ...
  useEffect(() => {
    (async () => {
      ...
      let isFilterPropertyEmpty = Object.values(Filter).every(
        (value) => value === ""
      );
      !isFilterPropertyEmpty ? await ListByFilterRequest(Filter) : null;
    })();
  }, [Filter]);
      ...
      <div className="container mt-2">
        <div className="row">
          <div className="col-md-3 p-2">
            <div className="card vh-100 p-3 :2Sadow-sm">
